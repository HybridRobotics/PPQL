...
start_state = QuadLoadState([-1;0;0.5],[0;0;0],[0;0;-1],[0;0;0],eye(3),[0;0;0]);
end_state = QuadLoadState([-1;0;0.5],[0;0;0],[0;0;-1],[0;0;0],eye(3),[0;0;0]);
...
traj.saveTrajReport('testXZWaypointLoad.mat');