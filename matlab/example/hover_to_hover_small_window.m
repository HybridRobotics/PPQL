...
local_setting1.defineTraveltimeBounded(0.5,2);
local_setting1.addWaypoint(Waypoint(25,'type','load',...
	'feasible_region',Polyhedron('lb',[-1;-0.10;1.1],'ub',[1;0.10;1.2])...
	));
local_setting1.addWaypoint(Waypoint(25,'type','load',...
...
obstacle1 = Polyhedron('lb',[-5; -0.05; -5], 'ub',[5; 0.05; 1.1]);
obstacle2 = Polyhedron('lb',[-5; -0.05; 1.8], 'ub', [5; 0.05; 5]);
